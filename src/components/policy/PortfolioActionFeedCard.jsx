...
export default function PortfolioActionFeedCard({ actions = [], onNavigate }) {
  if (!actions.length) return null;

  return (
    <SectionCard
      title="Portfolio Action Feed"
      subtitle="The next deterministic review moves generated from portfolio and policy signal pressure."
    >
