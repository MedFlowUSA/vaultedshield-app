...
export default function PropertyActionFeedCard({ actions = [], onAction }) {
  if (!actions.length) return null;

  return (
    <SectionCard title="Property Action Feed" subtitle="The next deterministic review moves generated from the current property signals.">
