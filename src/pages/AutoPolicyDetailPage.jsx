...
export default function AutoPolicyDetailPage({ autoPolicyId, onNavigate }) {
  ...
  function handleAutoTileAction(action) {
    if (action === "review_workspace") {
      onNavigate(autoReviewWorkspaceRoute);
      return;
    }
    if (action === "upload") {
    ...
    <div style={{ display: "grid", gap: "24px" }}>
      {loading ? (
        <div style={{ padding: "40px 24px", borderRadius: "20px", background: "#eff6ff", border: "1px solid #bfdbfe", color: "#1d4ed8", textAlign: "center" }}>
          <div style={{ fontWeight: 800, fontSize: "18px" }}>Loading auto policy detail</div>
          <div style={{ marginTop: "8px", color: "#334155" }}>VaultedShield is pulling together the policy, declarations, and supporting auto evidence.</div>
        </div>
      ) : !autoPolicy ? (
        <div style={{ padding: "40px 24px", borderRadius: "20px", background: "#fef3c7", border: "1px solid #fde68a", color: "#92400e", textAlign: "center", display: "grid", gap: "16px" }}>
          <div style={{ fontWeight: 800, fontSize: "18px" }}>Auto policy not found</div>
          <div style={{ color: "#78350f" }}>{loadError || "This auto policy detail page could not load a matching policy record."}</div>
          <button type="button" onClick={() => onNavigate("/insurance/auto")} style={{ padding: "10px 16px", borderRadius: "12px", border: "none", background: "#92400e", color: "#ffffff", fontWeight: 700, cursor: "pointer", justifySelf: "center" }}>
            Back To Auto Hub
          </button>
        </div>
      ) : (
        <>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "16px", flexWrap: "wrap" }}>
                <div style={{ display: "grid", gap: "8px" }}>
                  ...
                  <div style={{ fontSize: "24px", fontWeight: 900, lineHeight: "1.2" }}>{autoPolicy.policy_name || linkedAsset?.asset_name || "Auto Policy Detail"}</div>
                ...
                <div style={{ padding: "16px 20px", borderRadius: "18px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.15)", display: "grid", gap: "4px", textAlign: "center", minWidth: "100px", flexShrink: 0 }}>
                  <div style={{ fontSize: "32px", fontWeight: 900, lineHeight: 1, color: "#93c5fd" }}>{Math.min(100, Math.max(0, 42 + (bundle?.autoDocuments?.length || 0) * 8 + (bundle?.autoSnapshots?.length || 0) * 6))}</div>
                  <div style={{ fontSize: "11px", opacity: 0.6, fontWeight: 700, textTransform: "uppercase" }}>support</div>
                </div>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: "10px" }}>
                {autoHeroGlanceItems.map((item) => (
              ...
              <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                <button type="button" onClick={() => fileInputRef.current?.click()} style={{ padding: "10px 16px", borderRadius: "12px", border: "none", background: "#1d4ed8", color: "#ffffff", fontWeight: 700, fontSize: "13px", cursor: "pointer" }}>
                  Upload Policy Files
                </button>
                <button type="button" onClick={() => onNavigate(autoReviewWorkspaceRoute)} style={{ padding: "10px 16px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.3)", background: "transparent", color: "#ffffff", fontWeight: 700, fontSize: "13px", cursor: "pointer" }}>
                  Open Review Workspace
                </button>
                <button type="button" onClick={() => onNavigate("/insurance/auto")} style={{ padding: "10px 16px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.3)", background: "transparent", color: "#ffffff", fontWeight: 700, fontSize: "13px", cursor: "pointer" }}>
                  Back To Auto Hub
                </button>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "14px" }}>
              {[
                ...
                <div key={tile.kicker} style={{ padding: "20px", borderRadius: "18px", background: "#ffffff", border: "1px solid #e2e8f0", display: "grid", gap: "12px", alignContent: "start" }}>
                  ...
                  <button type="button" onClick={() => handleAutoTileAction(tile.action)} style={{ padding: "9px 14px", borderRadius: "10px", border: "1px solid #e2e8f0", background: "#f8fafc", fontWeight: 700, fontSize: "13px", color: "#0f172a", cursor: "pointer", textAlign: "left" }}>
                    {tile.actionLabel}
                  </button>
                </div>
              ))}
          ...
          <div ref={technicalAnalysisRef} style={{ ...surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" }), marginTop: "24px" }}>
              <div>
                <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Command</div>
                <div style={{ color: "#64748b", marginTop: "4px", fontSize: "14px" }}>The strongest auto protection blockers, why they matter, and what to do next on this policy.</div>
              </div>
          ...
          <div style={{ marginTop: "24px", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "18px" }}>
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Policy Summary</div>
          ...
          <div style={{ marginTop: "24px", display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: "18px" }}>
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Documents</div>
            ...
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Document Intake</div>
          ...
          <div style={{ marginTop: "24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "18px" }}>
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Snapshots</div>
            ...
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "14px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Analytics</div>
          ...
          {shouldShowDevDiagnostics() ? (
            <div style={surfaceCard({ padding: "22px 24px", display: "grid", gap: "8px" })}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#0f172a" }}>Auto Debug</div>
