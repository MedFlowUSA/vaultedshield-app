      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "16px", flexWrap: "wrap" }}>
          <div style={{ display: "grid", gap: "8px" }}>
            ...
            <div style={{ fontSize: "28px", fontWeight: 900, lineHeight: "1.2" }}>{reportsWelcomeGuide.title}</div>
            <div style={{ fontSize: "15px", opacity: 0.75, lineHeight: "1.6", maxWidth: "520px" }}>{reportsWelcomeGuide.summary}</div>
          </div>
          <div
            style={{
              padding: "16px 20px",
          ...
          >
            <div style={{ fontSize: "32px", fontWeight: 900, lineHeight: 1, color: "#7dd3fc" }}>{displayValue(householdScorecard?.overallScore)}</div>
            <div style={{ fontSize: "11px", opacity: 0.6, fontWeight: 700, textTransform: "uppercase" }}>of 100</div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          <button
            type="button"
            onClick={() => { setSelectedReport("household"); scrollToReportsSection("reports-active-view"); }}
            style={{ padding: "10px 16px", borderRadius: "12px", border: "none", background: "#0369a1", color: "#ffffff", fontWeight: 700, fontSize: "13px", cursor: "pointer" }}
          >
