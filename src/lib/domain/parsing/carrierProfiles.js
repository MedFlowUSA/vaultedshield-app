...
const SHARED_FIELD_LABELS = {
  illustration_summary: {
    ...
    option_type: ["death benefit option", "option type", "death benefit option type", "level death benefit", "increasing death benefit"],
    ...
    rider_summary: ["riders", "policy riders", "benefit riders", "optional riders", "coverage riders", "rider summary"],
  },
  statement_summary: {
    policy_number: ["policy number", "contract number", "certificate number", "policy no", "certificate no"],
    ...
    rider_summary: ["riders", "policy riders", "benefit riders", "coverage riders", "rider summary", "accelerated benefit rider", "chronic illness rider"],
