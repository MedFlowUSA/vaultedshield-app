...
const SHARED_FIELD_LABELS = {
  illustration_summary: {
    ...
    joint_insured_name: ["joint insured", "co-insured", "additional insured", "second insured"],
    insured_name: ["insured", "insured name", "primary insured"],
    payor_name: ["payor", "payer", "premium payor", "premium payer", "payor name"],
    trustee_name: ["trustee", "current trustee", "trustee name", "acting trustee"],
    trust_name: ["trust name", "owner trust", "trust owner name"],
    ownership_structure: ["ownership", "ownership structure", "owner type", "policy ownership", "trust owner"],
    primary_beneficiary_name: ["primary beneficiary", "primary beneficiary name", "beneficiary name", "designated beneficiary", "beneficiary", "beneficiary(ies)"],
    primary_beneficiary_share: ["primary beneficiary share", "primary beneficiary %", "primary share", "beneficiary percent", "primary allocation", "share of proceeds"],
    contingent_beneficiary_name: ["contingent beneficiary", "contingent beneficiary name", "secondary beneficiary", "alternate beneficiary", "successor beneficiary"],
    contingent_beneficiary_share: ["contingent beneficiary share", "contingent beneficiary %", "secondary beneficiary %", "alternate beneficiary %", "contingent allocation", "share of proceeds"],
    beneficiary_status: ["beneficiary designation", "beneficiary information", "designated beneficiary", "beneficiary", "beneficiary record", "beneficiary schedule", "beneficiary allocation"],
    death_benefit: ["death benefit", "initial death benefit", "specified amount", "face amount", "death benefit amount", "initial specified amount", "base face amount", "current face amount"],
    option_type: ["death benefit option", "option type", "death benefit option type", "death benefit option:", "death benefit qualification option", "level death benefit", "increasing death benefit"],
    planned_premium: ["planned premium", "annual premium", "modal planned premium", "target premium", "planned periodic premium", "modal premium", "periodic premium", "planned annual premium", "planned modal premium"],
    rider_summary: ["riders", "policy riders", "benefit riders", "optional riders", "coverage riders", "rider summary", "coverage benefits", "optional benefits"],
  },
  statement_summary: {
    policy_number: ["policy number", "contract number", "certificate number", "policy no", "certificate no"],
    statement_date: ["statement date", "report date", "statement ending date", "as of", "period ending", "statement period ending", "as of date", "statement as of", "reporting date", "year ending"],
    owner_name: ["owner", "owner name", "policy owner", "policyowner"],
    joint_insured_name: ["joint insured", "co-insured", "additional insured", "second insured"],
    insured_name: ["insured", "insured name", "primary insured"],
    payor_name: ["payor", "payer", "premium payor", "premium payer", "payor name"],
    ...
    contingent_beneficiary_name: ["contingent beneficiary", "contingent beneficiary name", "secondary beneficiary", "alternate beneficiary", "successor beneficiary"],
    contingent_beneficiary_share: ["contingent beneficiary share", "contingent beneficiary %", "secondary beneficiary %", "alternate beneficiary %", "contingent allocation", "share of proceeds"],
    beneficiary_status: ["beneficiary designation", "beneficiary information", "beneficiary", "beneficiary record", "beneficiary schedule", "beneficiary allocation"],
    accumulation_value: ["accumulation value", "account value", "policy value", "total accumulation value", "total account value", "current account value", "end of year account value"],
    cash_value: ["cash value", "net cash value", "current cash value"],
    cash_surrender_value: ["cash surrender value", "surrender value", "net cash surrender value", "net surrender value", "net surrender value available", "net cash surrender value available"],
    death_benefit: ["death benefit", "current death benefit", "death benefit amount", "face amount", "specified amount", "current face amount"],
    option_type: ["death benefit option", "option type", "death benefit option type", "death benefit option:", "level death benefit", "increasing death benefit"],
    loan_balance: ["loan balance", "policy loan balance", "indebtedness", "outstanding loan balance", "total loan balance", "loan indebtedness", "net loan balance"],
    rider_summary: ["riders", "policy riders", "benefit riders", "coverage riders", "rider summary", "accelerated benefit rider", "chronic illness rider", "living benefit rider"],
    premium_paid: ["premium paid", "premium received", "planned premium", "premium", "premiums paid ytd", "current year premium", "ytd premium"],
    policy_charges_total: ["policy charges", "total charges", "monthly deduction", "annual charges", "visible charges", "total monthly deductions", "deductions and charges"],
  },
  charges_table: {
    cost_of_insurance: ["cost of insurance", "coi", "insurance charge", "insurance charges", "policy cost of insurance", "mortality charge", "monthly mortality charge"],
    monthly_deduction: ["monthly deduction", "monthly deductions", "monthly charges", "deduction", "deductions"],
    expense_charge: ["expense charge", "expense charges", "premium expense", "premium load", "other charges", "asset based charge", "expense deduction"],
    admin_fee: ["administrative charge", "administrative fee", "policy fee", "admin fee", "administration charge", "monthly administration charge"],
    rider_charge: ["rider charge", "rider charges", "cost of riders", "rider(s) charges", "benefit rider charge"],
  },
  allocation_table: {
    index_strategy: ["indexed account", "allocation option", "strategy", "interest option", "indexed strategy", "crediting strategy", "index account strategy", "segment", "strategy option"],
    allocation_percent: ["allocation percent", "allocation %", "percent allocated", "allocation", "% of accumulation value", "% allocated", "allocation to strategy"],
    cap_rate: ["cap rate", "cap %", "annual cap rate"],
    participation_rate: ["participation rate", "participation %", "par rate", "participation"],
    spread: ["spread", "asset fee spread", "spread rate"],
    crediting_rate: ["crediting rate", "index credit", "declared rate", "credited rate", "interest credit rate", "fixed account rate"],
    fixed_account_value: ["fixed account", "fixed account value", "declared interest account", "fixed strategy value", "fixed bucket value"],
    indexed_account_value: ["indexed account value", "index account value", "total of index accounts", "indexed strategy value", "index bucket value"],
  },
};
